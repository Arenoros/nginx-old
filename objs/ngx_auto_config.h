#define NGX_CONFIGURE " --crossbuild=QNX:6.5.0:arm --with-cc=arm-unknown-nto-qnx6.5.0-gcc --with-ld-opt=-lsocket --prefix=nginx --add-module=modules/nginx-let-module --with-pcre"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 4.4.2 (GCC) "
#endif
